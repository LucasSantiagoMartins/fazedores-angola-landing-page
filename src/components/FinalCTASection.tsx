    ...
    <section ref={ref} className="relative py-20 md:py-28 bg-background overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        <motion.div
          ...
          className="max-w-4xl mx-auto text-center glass rounded-2xl p-8 md:p-14 shadow-glow gpu"
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <DoerButton asChild variant="primary" size="lg" className="w-full sm:w-auto">
              <a
            ...
            <DoerButton asChild variant="outline" size="lg" className="w-full sm:w-auto">
              <a
