          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-gradient-primary text-primary-foreground font-semibold text-base sm:text-lg px-8 py-4 rounded-full transition-transform duration-300 hover:scale-[1.03] animate-pulse-glow gpu"
              >
                Criar conta
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 glass-dark text-white font-semibold text-base sm:text-lg px-8 py-4 rounded-full transition-all duration-300 hover:bg-white/10 hover:scale-[1.03] gpu"
              >
